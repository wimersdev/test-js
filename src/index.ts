...
function about3d() {
  ...
  meshGroup.scale.y = sizes.width / scaleValue;
  meshGroup.scale.z = sizes.width / scaleValue;
  meshGroup.rotation.y = -1.6;
  meshGroup.rotation.x = -0.3;
  scene.add(meshGroup);
  ...
  //Load cube
  gltfLoader.load(
    'https://uploads-ssl.webflow.com/6385ed21375f1c00a4a3f887/63f5dd33c18d2333787b56ba_head.txt',
    (gltf) => {
  ...
  //Light
  const pointLight = new THREE.PointLight(0x404040, 22);
  pointLight.position.set(1, 1, 2.2);
